...
<template>
    <main class="grid min-h-full place-items-center bg-gray px-6 py-24 sm:py-32 lg:px-8 ">
        <div class="text-center">
            ...
            <div class="mt-10 flex items-center justify-center gap-x-6 btn">
                    <RouterLink to="/" class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded">Back to Safety</RouterLink>
